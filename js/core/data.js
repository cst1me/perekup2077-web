...
export const comments = [
  ...
  "Эту тачку угонщики возвращали","На запахе бензина едет","Катализатор в багажнике",
  "ABS отключил, мешает","Печка как у тёщи","Check Engine — индикатор настроения",
  "Подвеска мягкая — ям не чувствуешь","Кузов звенит — это акустика","Генератор новый — старый украли",
  "Фары светят — иногда обе сразу","Сцепление хватает в конце хода","Тормоза на ручнике работают",
  "Движок не стучит — он рэп читает","Краска родная — местами","Антифриз испаряется сам"
];
...
export const scamComments = [
  ...
  "Могу скинуть 70%, если сейчас переведёшь","ПТС дубликат, оригинал потерялся","Задаток чтобы забронировать"
];
...
export const legendaryComments = [
  ...
  "История этой тачки — отдельный фильм","Музейный экспонат, продаю со слезами"
];
